...
######################
'''
_MS_COCO_STUFF_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 118288,
        'val': 5001,
    },
...
_MS_COCO_STUFF_INFORMATION = DatasetDescriptor(
    ...
    num_classes=92, ################# 118288, 5001, 92 ### 91 without back ####92 with background 0
    ignore_label=255,
)
...
_DATASETS_INFORMATION = {
    ...
    'ms_coco_stuff':_MS_COCO_STUFF_INFORMATION,
}
